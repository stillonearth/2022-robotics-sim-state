...
EPSILON = 1.0           # Noise cooefficient
EPSILON_DECAY = 1e-6    # Noise decay

N_OPTIMIZER_ITERATIONS = 10
N_ACT_ITERATIONS = 20
...
class Agent():
    ...
    def step(self, states, actions, rewards, next_states, dones, timestep):
        ...
        if len(self.memory) > BATCH_SIZE and timestep % N_ACT_ITERATIONS == 0:
            for _ in range(N_OPTIMIZER_ITERATIONS):
